<template>
	<view class="main" :style="{height:windowHeight+'px'}" style="overflow: hidden">
		...
		<view style="margin-top: 150rpx;" class="grid justify-around"  data-target="Modal">
		...
		<swiper class="swiper round-dot" :indicator-dots="true" :circular="true"
		 :autoplay="true" interval="2000" duration="500" @change="posterSwiperChange" :current="currentPosterIndex" 
		 indicator-active-color="#fbbd08" indicator-color="#fff">
		...
		<view class="grid justify-center action-wrapper" style="margin-top: 25rpx;">
			<view class="grid col-1">
				<button @click="downloadMiniCode" class="cu-btn round bg-yellow"> <text class="cuIcon-down"></text>保存</button>
			</view>
		</view>
		<view>
